...
// comment rechercher les utilisateur et les roles soit bd ou annuaire
       //on memory authentication

       /*
        String encodedPWD= passwordEncoder.encode("1234");
        System.out.println(encodedPWD);
        auth.inMemoryAuthentication().withUser("user1").password(encodedPWD).roles("USER");//{noop} no password encodeur
...
http.authorizeRequests().anyRequest().authenticated();//tt les requetyes http necessit une aunthzntication
